...
public class Purification implements Callable<ArrayList<String>>{
	...
	StringArray.set(i,StringArray.get(i).replace(StringArray.get(i).substring(StringArray.get(i).lastIndexOf("."), StringArray.get(i).length()), ""));
...
public ArrayList<String> call(){
	...
	if (LoweredString.get(i).contains(XMLString.get(j))){
		if ((LoweredString.get(i).contains("(")) && (LoweredString.get(i).indexOf("(") < LoweredString.get(i).indexOf(XMLString.get(j))) && (LoweredString.get(i).indexOf(")") > LoweredString.get(i).indexOf(XMLString.get(j)))){
			StringArray.set(i, StringArray.get(i).replace(StringArray.get(i).substring(LoweredString.get(i).indexOf("("), StringArray.get(i).length()), "" ));
			LoweredString.set(i,StringArray.get(i).toLowerCase());
			
		}
		else{
		
		StringArray.set(i, StringArray.get(i).replace(StringArray.get(i).substring(LoweredString.get(i).indexOf(XMLString.get(j)), StringArray.get(i).length()), "" ));
		LoweredString.set(i,StringArray.get(i).toLowerCase());
...
private String getpackname(){
	String string = (Purification.class.getPackage().getName().toString().replace(".", "/")+"/resources/options/Purifier.xml");
